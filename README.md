...
3. [Electro-Mechanical Design Overview](#electro-mechanical-design-overview)
4. [Firmware Design Overview](#firmware-design-overview)
   1. [Hardware Drivers](#hardware-drivers)
      - [BNO055 Driver](#bno055-driver)
      - [Motor Driver](#motor-driver)
      - [Encoder Driver](#encoder-driver)
      - [IR Sensor Driver](#ir-sensor-driver)
      - [Bump Sensor Driver](#bump-sensor-driver)
   2. [Line Following](#line-following)
   3. [Heading Control](#heading-control)
   4. [Cooperative Multitasking](#cooperative-multitasking)
