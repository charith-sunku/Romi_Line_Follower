...
# ---------------------------------------------
diamond = task_share.Share('b', thread_protect=False, name="Diamond Flag")
diamond.put(0)  # 0 = normal, 1 = diamond triggered, 2 = diamond maneuver complete
...
def Controller_Task(shares):
    ...
    system_done, calibration, R_pwm_effort, L_pwm_effort, centroid, diamond, romi_heading = shares
    state = 0
...
# =============================================================================
            ...
            if (not diamond_mode) and (89 <= current_heading <= 92) and diamond.get() != 2:
...
# =============================================================================
            if diamond_mode:
                ...
                if diamond_length >= 3.2:
                    ...
                    diamond_mode = False
                    diamond.put(2)  # Indicate diamond maneuver complete.
            else:
# =============================================================================
...
task4_obj = cotask.Task(Controller_Task,
                        ...
                        period=12,
                        profile=False,
                        shares=(system_done, calibration, R_pwm_effort, L_pwm_effort, centroid, diamond, romi_heading))
